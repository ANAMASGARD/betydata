...
homepage_top_traits(traitsview) |>
  knitr::kable(col.names = c("Trait", "Observations"), row.names = FALSE)
```
...
homepage_top_species(traitsview)[, c("species", "observations")] |>
  knitr::kable(col.names = c("Species", "Observations"), row.names = FALSE)
```
